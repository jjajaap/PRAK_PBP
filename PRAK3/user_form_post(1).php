      ...
      <div class="card-body">
        <form method="POST" autocomplete="on" action="">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="jenis_kelamin" value="pria" required>Pria
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="jenis_kelamin" value="wanita" required>Wanita
            </label>
          </div>
          <br>
        ...
        if (isset($_POST["submit"])) {
          ...
          if (isset($_POST['minat'])) {
            echo 'Peminatan = ' . htmlspecialchars(implode(', ', $_POST['minat'])) . '<br />';
          } else {
